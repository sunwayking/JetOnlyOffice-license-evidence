...
| `qt` | `GPL-3.0-only AND MIT AND BSD-3-Clause AND BSD-2-Clause AND Zlib AND Libpng AND libpng-2.0 AND IJG AND libtiff AND CC0-1.0 AND LicenseRef-Public-Domain` | `qt/LICENSE.GPLv3`, `qt/LICENSE.LGPLv3`, `qt/LICENSE.GPLv2`, `qt/charts-LICENSE.GPL3.txt`, `qt/datavis3d-LICENSE.GPL3.txt`, `qt/virtualkeyboard-LICENSE.GPL3.txt`, `qt/networkauth-LICENSE.GPL3.txt`, `qt/networkauth-LICENSE.GPL3-EXCEPT.txt`, `qt/zlib.h`, `qt/png.h`, `qt/libjpeg-8c-README.txt`, `qt/libtiff-4.1.0-COPYRIGHT.txt`, `qt/libwebp-COPYING.txt`, `qt/pcre2-LICENCE.txt`, `qt/double-conversion-LICENSE.txt`, `qt/harfbuzz-MIT.txt` |
